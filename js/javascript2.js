    ...
    const todos = getAll()
        .then(data => {
            ...
            data.forEach((element, index) => {
                ...
                col5.innerHTML = `<a class="btn btn-danger"  href="#" onclick="eliminar(${element.id})">Eliminar</a>`;
...
document.getElementById("btnGuardar").addEventListener("click", (e) => {
    ...
    guardar(compra)
        ...
        .then(data => {
            ...
            var col5 = document.createElement("TD");
            col5.innerHTML = `<a class="btn btn-danger"href="#" onclick="eliminar(${data.id})">Eliminar</a>`;
            row.appendChild(col1);
            row.appendChild(col2);
            row.appendChild(col3);
            row.appendChild(col4);
